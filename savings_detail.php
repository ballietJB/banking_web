										...
										<div id="collapseTwo" class="panel-collapse collapse">
											<div class="panel-body">
												<div class="well wbRemoveBox">
													<h4>Brief highlights</h4>
													<ul>
														<li><strong>Monthly Fee:</strong> <?php echo $currency_symbol;?>10</li>
														<li><strong>Minimum Opening Deposit:</strong> <?php echo $currency_symbol;?>5,000</li>
														<li><strong>Annual Percentage Yield(APY):</strong> 0.03% - 0.07%</li>
													</ul>
										...
										<div class="panel-heading wbApplyOnline">
											<div id="" class="well wbRemoveBox">
						                		<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
													...
													<p>You want premium rates for a minimum deposit of <?php echo $currency_symbol;?>25,000</p>
												</a>
											</div>
										</div>
											...
											<div class="panel-body">
												<div class="well wbRemoveBox">
													...
													<ul>
														...
														<li><strong>Annual Percentage Yield(APY):</strong> from 0.01% to 0.05%</li>
													</ul>
						   ...
						   <div class="col-sm-11 col-sm-offset-1">
							   ...
							   <div id="TH_MyAccounts_FeatureBox3">
									<div class="well wbFeatureBox wbBackgroundGrey" style="padding: 0px 10px 13px 10px">
										<div id="featureIcon" style="float: left;margin-top: 5px"><img src="themes/wealth_banking_theme/images/icons/icon-question.png" width="100px" height="100px"></div>
										<div id="featureContent" style="margin-left: 110px">
